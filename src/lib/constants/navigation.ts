...
export const USER_NAV_CONFIG: UserNavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'history.franchise-history', label: 'Franchise History', href: '/history/franchises', group: 'League Archive' },
      { id: 'history.all-evw', label: 'All-EVW Teams', href: '/history/all-evw', group: 'League Archive' },
      { id: 'history.awards', label: 'Awards & Highs', href: '/history/awards', group: 'League Archive' },
      { id: 'history.gamebooks', label: 'Weekly Gamebooks', href: '/history/gamebook', group: 'League Archive' },
      { id: 'history.milestones', label: 'Milestones', href: '/history/milestones', group: 'League Archive' },
      { id: 'history.stats', label: 'Stats', href: '/history/stats', group: 'Stats & Records' },
    ],
  },
  {
    id: 'draft',
