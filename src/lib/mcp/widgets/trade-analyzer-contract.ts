...
const assetSchema = {
  ...
  properties: {
    ...
    nflTeam: { type: 'string' },
    value: { type: 'number' },
    fcValue: nullableNumberSchema,
    ktcValue: nullableNumberSchema,
    isPick: { type: 'boolean' },
    trend: { type: 'number' },
  },
...
const sideSchema = {
  ...
  properties: {
    ...
    posSummary: { type: 'string' },
    rawTotal: { type: 'number' },
    effectiveTotal: { type: 'number' },
    grade: { type: 'string' },
  },
  ...
  properties: {
    analysis: {
      ...
      properties: {
        ratio: { type: 'number' },
        verdict: { type: 'string' },
        winner: { anyOf: [{ type: 'string', enum: ['A', 'B'] }, { type: 'null' }] },
        diff: { type: 'number' },
        effA: { type: 'number' },
        effB: { type: 'number' },
        rawA: { type: 'number' },
        rawB: { type: 'number' },
        sideAGrade: { type: 'string' },
        sideBGrade: { type: 'string' },
