...
const positionSummarySchema = {
  ...
  properties: {
    ...
    topPlayer: nullableStringSchema,
  },
  ...
  properties: {
    ...
    data: {
      ...
      properties: {
        ...
        totalDynastyValue: { type: 'number' },
        positionSummary: {
          type: 'object',
          additionalProperties: false,
          properties: {
            QB: positionSummarySchema,
            RB: positionSummarySchema,
            WR: positionSummarySchema,
            TE: positionSummarySchema,
          },
        ...
        positions: {
          ...
          additionalProperties: false,
          properties: {
            QB: { type: 'array', items: positionPlayerSchema },
            RB: { type: 'array', items: positionPlayerSchema },
            WR: { type: 'array', items: positionPlayerSchema },
            TE: { type: 'array', items: positionPlayerSchema },
          },
        },
...
export const ROSTER_STRENGTH_TOOL_META = {
  'openai/outputTemplate': ROSTER_STRENGTH_WIDGET_URI,
  ui: { resourceUri: ROSTER_STRENGTH_WIDGET_URI },
} as const;
