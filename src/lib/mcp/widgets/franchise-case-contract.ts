...
export const FRANCHISE_CASE_TOOL_META = {
  'openai/outputTemplate': FRANCHISE_CASE_WIDGET_URI,
  ui: { resourceUri: FRANCHISE_CASE_WIDGET_URI },
} as const;

export const FRANCHISE_CASE_RESOURCE_META = {
  ui: {
    prefersBorder: true,
    domain: FRANCHISE_CASE_BASE_URL,
    csp: {
      resourceDomains: [FRANCHISE_CASE_BASE_URL],
    },
  },
