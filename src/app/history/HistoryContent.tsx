          ...
          {bracketLoading ? (
            ...
            <div className="space-y-8">
              <PlayoffBracketPanel
                ...
                keyPrefix={`history-${bracketYear}-winners`}
                emptyMessage={`No winners bracket available for ${bracketYear}.`}
              />
              <PlayoffBracketPanel
                title="Toilet Bowl"
                games={losersBracket}
                ...
                nameMap={bracketNameMap}
                seedMap={seedByRosterId}
                keyPrefix={`history-${bracketYear}-losers`}
                emptyMessage={`No losers bracket available for ${bracketYear}.`}
              />
            </div>
          )}
        </div>
