...
export async function POST(request: NextRequest) {
  ...
  const prospectPool = (derivedData.__prospectPool as Array<{ name: string; pos: string; nfl?: string | null; college?: string | null; rank: number | null; value?: number | null; stats?: string[] | null; nflPick?: number | null; verdict?: string | null }> | null) ?? null;
