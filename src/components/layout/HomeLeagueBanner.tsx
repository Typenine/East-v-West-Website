        ...
        return (
          <div
            ...
            style={{
              ...
              background: `linear-gradient(180deg, ${colors.primary}22 0%, rgba(255,255,255,0.06) 100%)`,
...
export default function HomeLeagueBanner() {
  return (
    <div className="relative overflow-hidden border-b border-[var(--border)] bg-[linear-gradient(135deg,#08111f_0%,#101d33_100%)]">
      ...
      />
      <div className="container mx-auto px-4 sm:px-5 py-4 sm:py-5 lg:py-6 relative z-10">
        <div
          className="relative overflow-hidden rounded-[28px] border p-4 sm:p-5 lg:p-7"
          style={{
            borderColor: 'rgba(255,255,255,0.18)',
        ...
        >
          ...
          />
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-5 lg:gap-8 items-center">
            <TeamGrid teams={leftTeams} />
            <div className="grid place-items-center gap-4 w-full lg:w-[clamp(220px,18vw,340px)] order-first lg:order-none mx-auto">
              <Link
                href="/"
                className="w-full aspect-square rounded-[28px] border p-5 sm:p-6 lg:p-7 backdrop-blur-md flex items-center justify-center"
                style={{
              ...
              >
                <Image
                  ...
                  height={280}
                  priority
                  className="w-full h-full object-contain drop-shadow-[0_12px_18px_rgba(0,0,0,0.48)]"
                />
              </Link>
              <div className="text-center uppercase tracking-[0.18em]">
                <div className="text-[11px] sm:text-[12px] lg:text-[13px] font-extrabold text-[#bf9944]">Dynasty Fantasy Football</div>
                <div className="mt-1 text-[20px] sm:text-[22px] lg:text-[28px] font-black leading-none text-[var(--text)]">East v. West League</div>
              </div>
            </div>
